 ...
 */
namespace Neutron\DataGridBundle\DataGrid\Provider;
...
class DataGridProvider implements DataGridProviderInterface
{
     ...
     * (non-PHPdoc)
     *
     * @see Neutron\DataGridBundle\DataGrid\Provider.DataGridProviderInterface::get()
     */
     ...
     * (non-PHPdoc)
     *
     * @see Neutron\DataGridBundle\DataGrid\Provider.DataGridProviderInterface::has()
     */
