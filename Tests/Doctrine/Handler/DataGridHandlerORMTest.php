<?php
namespace Neutron\DataGridBundle\Tests\Doctrine\Handler;

use Neutron\DataGridBundle\Tests\Fixture\Entity\GridDependent;

use Neutron\DataGridBundle\Tests\Fixture\Entity\GridMaster;

use Neutron\DataGridBundle\Doctrine\ORM\DataGridHandler;
...
{
    const GRID_MASTER = 'Neutron\DataGridBundle\Tests\Fixture\Entity\GridMaster';
    
    const GRID_DEPENDANT = 'Neutron\DataGridBundle\Tests\Fixture\Entity\GridDependent';
    ...
    protected function getQueryBuilder()
    {
        ...
        $qb
            ...
            ->from('\Neutron\DataGridBundle\Tests\Fixture\Entity\GridMaster', 'm')
            ->leftJoin('m.grids', 's')
            ->groupBy('m.id')
        ;
    ...
    private function getQueryBuilderForDependentGrid()
    {
        ...
        $qb
            ...
            ->from('\Neutron\DataGridBundle\Tests\Fixture\Entity\GridDependent', 's')
            ->join('s.master', 'm')
