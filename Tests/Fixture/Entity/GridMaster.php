<?php
namespace Neutron\DataGridBundle\Tests\Fixture\Entity;
...
class GridMaster
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="\Neutron\DataGridBundle\Tests\Fixture\Entity\GridDependent", mappedBy="master", cascade={"all"})
     */  
    protected $grids; 
