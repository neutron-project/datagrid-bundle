<?php
namespace Neutron\DataGridBundle\Tests\Controller;
...
use Neutron\DataGridBundle\Controller\DataGridController;
...
class DataGridControllerTest extends BaseTestCase
{
    ...
    public function testGetDataGrid()
    {
        ...
        $container->set('neutron_data_grid.provider', $this->getMockProvider());
        ...
        $this->assertInstanceOf('Neutron\DataGridBundle\DataGrid\DataGridInterface', $result);
    ...
    public function testGetDataGridWithInvalidName()
    {
        ...
        $mockProvider = $this->getMock('Neutron\DataGridBundle\DataGrid\Provider\DataGridProviderInterface');
        ...
        $container = new Container();
        $container->set('request', $mockRequest);
        $container->set('neutron_data_grid.provider', $mockProvider);
    ...
    public function testDataAction()
    {
        ...
        $container->set('neutron_data_grid.provider', $this->getMockProvider());
        $container->set('neutron_data_grid.handler.datagrid', $this->getMockDataGridHandler());
    ...
    public function testMassAction()
    {
        ...
        $container->set('event_dispatcher', $this->getMockEventDispatcher());
        $container->set('neutron_data_grid.provider', $this->getMockProvider());
        $container->set('neutron_data_grid.handler.datagrid', $this->getMockDataGridHandlerForMassActionTest());
    ...
    {
        $mock = $this->getMock('Neutron\DataGridBundle\DataGrid\Provider\DataGridProviderInterface');
        ...
        $mock
            ...
            ->method('get')
            ->with('test')
            ->will($this->returnValue($this->getMock('Neutron\DataGridBundle\DataGrid\DataGridInterface')))
        ;
    ...
    {
        $mock = $this->getMock('Neutron\DataGridBundle\DataGrid\DataGridHandlerInterface');
        
        $mock
            ->expects($this->once())
            ->method('setDataGrid')
            ->with($this->getMock('Neutron\DataGridBundle\DataGrid\DataGridInterface'))
