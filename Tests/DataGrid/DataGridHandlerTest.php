<?php
namespace Neutron\DataGridBundle\Tests\DataGrid;

use Neutron\DataGridBundle\Tests\Stub\DataGridHandlerStub;
...
class DataGridHandlerTest extends BaseTestCase
{
    ...
    public function testGetDataGrid()
    {
        ...
        $dataGridHandler->setDataGrid($this->getMock('Neutron\DataGridBundle\DataGrid\DataGridInterface'));
        
        $this->assertInstanceOf('Neutron\DataGridBundle\DataGrid\DataGridInterface', $dataGridHandler->getDataGrid());
    }
