<?php
namespace Neutron\DataGridBundle\Tests\DataGrid\Provider;

use Neutron\DataGridBundle\DataGrid\Provider\DataGridProvider;
...
class DataGridProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $dataGrid = $this->getMock('Neutron\DataGridBundle\DataGrid\DataGridInterface');
