<?php
namespace Neutron\DataGridBundle\Tests\DependancyInjection\Compiler;
...
class DataGridCompilerPassTest extends BaseTestCase
{
    ...
    public function testProcessWithEmptyAlias()
    {
        ...
        $containerBuilderMock->expects($this->once())
            ...
            ->with($this->equalTo('neutron_data_grid.datagrid'))
    ...
    public function testProcessWithAlias()
    {
        ...
        $containerBuilderMock
            ...
            ->with($this->equalTo('neutron_data_grid.provider'))
