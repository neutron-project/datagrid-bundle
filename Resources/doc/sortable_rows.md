...
**Theory of operation:** When you sort a row an ajax post request is sent to *DataGridController* and then is dispatched *neutron_datagrid.onRowPositionChange* event.
