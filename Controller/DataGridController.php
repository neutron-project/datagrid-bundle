...
class DataGridController extends ContainerAware
{
    ...
    public function dataAction ($name)
    {
        ...
        $handler = $this->container->get('neutron_data_grid.handler.datagrid');
    ...
    public function rowAction ($name)
    {
        ...
        $eventType = 'neutron_datagrid.onRow' . ucfirst($oper);
    ...
    public function getDataGrid ($name)
    {
        ...
        $provider = $this->container->get('neutron_data_grid.provider');
